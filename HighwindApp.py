...
import glm
import math
from Highwind import *
a = 0

class HighwindApp(GLAPP):
    ...
    def draw(self):
        ...
        camera = glm.lookAt(glm.vec3(20,40,20),glm.vec3(0,10,0),glm.vec3(0,0,1))
        model = glm.rotate(a,glm.vec3(0,0,1))*glm.translate(glm.vec3(10,0,0))
